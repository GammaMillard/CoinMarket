    ...
    <main className=''>
      <div className="wrapper flex">
        ...
        <section className='w-full'>
          <UserInfo />
          <div className="data-holder w-full h-full border border-green-300 p-4">
            <div className="actualdata w-full h-full border border-pink-400 flex flex-wrap gap-7" >
              <div className='w-52 h-32 border border-blue-700'>
                <div className="names">
                  <p>NAME</p>
              ...
              <div className='w-52 h-32 border border-red-700'>
                <div className="names">
                  <p>NAME</p>
                  <div className='date-range'></div>
                  <div className='drag-icon'></div>
